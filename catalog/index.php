...
$APPLICATION->SetPageProperty("title", "Туры из Казахстана 2018 - 2019");
$APPLICATION->SetPageProperty("keywords", "Каталог туров, туры из казахстана, горящие туры из казахстана, пляжные туры из казахстана, горнолыжные туры, лечебные туры, экскурсионные туры.");
$APPLICATION->SetPageProperty("description", "В данном каталоге Вы можете ознакомиться с турами, которые предлагает наша туристическая компания. Здесь есть горящие, пляжные, горнолыжные, лечебные и экскурсионные туры из Казахстана.");
$APPLICATION->SetPageProperty("MENU_SHOW_ELEMENTS", "Y");
$APPLICATION->SetTitle("Туры из Казахстана 2018 - 2019");
