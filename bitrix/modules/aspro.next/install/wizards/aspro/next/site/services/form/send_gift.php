...
$by = "id"; $order = "asc";
$arFields = array("ACTIVE" => "Y", "EVENT_NAME" => "FORM_FILLING_SEND_GIFT", "LID" => WIZARD_SITE_ID, "EMAIL_FROM" => $wizard->GetVar("shopEmail"), "EMAIL_TO" => "#EMAIL_RAW#", "SUBJECT" => GetMessage("NEW_SEND_GIFT_EMAIL_SUBJECT"), "MESSAGE" => GetMessage("NEW_SEND_GIFT_EMAIL_TEXT"), "BODY_TYPE" => "html", "SITE_TEMPLATE_ID" => "aspro_mail");
