...
unset($_SESSION["NEXT_HBLOCK_CONTACT_ID"]);

$dbHblock = HL\HighloadBlockTable::getList(array("filter" => array("NAME" => "AsproNextContactReference")));
if(!$dbHblock->Fetch()){
	$data = array('NAME' => 'AsproNextContactReference', 'TABLE_NAME' => 'b_hlbd_sposobyoplaty');
	$result = HL\HighloadBlockTable::add($data);
	$HL_ID = $result->getId();
	$_SESSION["NEXT_HBLOCK_CONTACT_ID"] = $HL_ID;
...
$dbHblock = HL\HighloadBlockTable::getList(array("filter" => array("NAME" => "AsproNextTizerReference")));
if(!$dbHblock->Fetch()){
	$data = array('NAME' => 'AsproNextTizerReference', 'TABLE_NAME' => 'next_tizers_reference');
	$result = HL\HighloadBlockTable::add($data);
	$HL_ID = $result->getId();
	$_SESSION["NEXT_HBLOCK_TIZER_ID"] = $HL_ID;
...
$dbHblock = HL\HighloadBlockTable::getList(array("filter" => array("NAME" => "AsproNextColorReference")));
if(!$dbHblock->Fetch()){
	$data = array('NAME' => 'AsproNextColorReference', 'TABLE_NAME' => 'next_color_reference');
	$result = HL\HighloadBlockTable::add($data);
	$HL_ID = $result->getId();
	$_SESSION["NEXT_HBLOCK_COLOR_ID"] = $HL_ID;
