...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	$codeProp = 'POPUP_VIDEO';
	$dbProperty = CIBlockProperty::GetList(array(), array('IBLOCK_ID' => $iblockID, 'CODE' => $codeProp));

	$ibp = new CIBlockProperty;
	$bUrlExcPropAdd = false;
	if(!$dbProperty->SelectedRowsCount())
	{
		$arFields = Array(
			'NAME' => GetMessage('POPUP_VIDEO'),
			'ACTIVE' => 'Y',
			'SORT' => '100',
			'IBLOCK_ID' => $iblockID,
			'CODE' => $codeProp,
