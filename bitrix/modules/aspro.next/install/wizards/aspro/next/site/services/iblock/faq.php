...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_98").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--NAME--#--'.GetMessage("WZD_OPTION_54").'--,--XML_ID--#--'.GetMessage("WZD_OPTION_218").'--,--SORT--#--'.GetMessage("WZD_OPTION_44").'--,--IBLOCK_ELEMENT_PROPERTY--#--'.GetMessage("WZD_OPTION_128").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_130").'--,--PROPERTY_'.$arProperty["TITLE_BUTTON"].'--#--'.GetMessage("WZD_OPTION_264").'--,--PROPERTY_'.$arProperty["LINK_BUTTON"].'--#--'.GetMessage("WZD_OPTION_266").'--;--edit5--#--'.GetMessage("WZD_OPTION_100").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_268").'--;--;--',
	));
	// list user options
	CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
		'columns' => 'ACTIVE,NAME,SORT,ID', 'by' => 'sort', 'order' => 'asc', 'page_size' => '20',
	));
}
