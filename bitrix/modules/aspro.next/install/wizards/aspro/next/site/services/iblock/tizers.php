...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_214").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--NAME--#--'.GetMessage("WZD_OPTION_54").'--,--SORT--#--'.GetMessage("WZD_OPTION_44").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_122").'--,--PROPERTY_'.$arProperty["SHOW_ON_INDEX_PAGE"].'--#--'.GetMessage("WZD_OPTION_289").'--,--PROPERTY_'.$arProperty["LINK"].'--#--'.GetMessage("WZD_OPTION_216").'--;--;--',
	));
	// list user options
	CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
		'columns' => 'ACTIVE,PREVIEW_PICTURE,NAME,PROPERTY_'.$arProperty["SHOW_ON_INDEX_PAGE"].',PROPERTY_'.$arProperty["LINK"].',SORT,TIMESTAMP_X,ID', 'by' => 'sort', 'order' => 'asc', 'page_size' => '20',
	));
}
