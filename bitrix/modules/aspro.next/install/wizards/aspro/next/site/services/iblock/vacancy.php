...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_102").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--NAME--#--'.GetMessage("WZD_OPTION_54").'--,--PROPERTY_'.$arProperty["PAY"].'--#--'.GetMessage("WZD_OPTION_104").'--,--CODE--#--'.GetMessage("WZD_OPTION_106").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_14").'--;--edit2--#--'.GetMessage("WZD_OPTION_108").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_110").'--;--;--',
	));
	// list user options
	CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
		'columns' => 'ACTIVE,NAME,PROPERTY_'.$arProperty["PAY"].',SORT,ID', 'by' => 'sort', 'order' => 'asc', 'page_size' => '20',
	));
}
