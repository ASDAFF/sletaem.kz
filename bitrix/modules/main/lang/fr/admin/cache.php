...
$MESS["MAIN_OPTION_HTML_CACHE_WARNING_TRANSID"] = "Attention! Le paramètre session.use_trans_sid est désactivé. La mise en cache HTML ne fonctionnera pas.";
$MESS["MAIN_OPTION_HTML_CACHE_WARNING"] = "Attention ! Les modules de statistique ou de publicité sont installés. Pour la mise en cache HTML, l'acquisition des données sera réalisée incorrectement.";
$MESS["MAIN_OPTION_CLEAR_CACHE_ALL"] = "Tous";
$MESS["main_cache_managed_turn_off"] = "Désactiver le cache réglable (n'est pas recommandé)";
$MESS["MAIN_OPTION_HTML_CACHE_QUOTA"] = "Quota de disque (mégaoctets)";
$MESS["main_cache_in_progress"] = "La suppression des fichiers de la cache est en cours.";
$MESS["MAIN_OPTION_HTML_CACHE_INC_MASK"] = "Masque d'inclusion";
$MESS["MAIN_OPTION_HTML_CACHE_EXC_MASK"] = "Masque d'exclusion";
...
$MESS["MAIN_OPTION_HTML_CACHE_RESET"] = "Mettre des réglages par défaut";
$MESS["MAIN_OPTION_HTML_CACHE_ON"] = "Paramètres de cache HTML";
...
$MESS["MAIN_OPTION_HTML_CACHE_BUTTON_ON"] = "Activer le cache HTML";
...
$MESS["MAIN_OPTION_HTML_CACHE_BUTTON_OFF"] = "Cache HTML désactiver";
$MESS["MAIN_OPTION_CACHE_BUTTON_OFF"] = "Désactiver la Mise en cache";
$MESS["MAIN_OPTION_HTML_CACHE_OFF"] = "Cache HTML est éteint";
$MESS["MAIN_TAB_4"] = "La mise en cache de composants";
$MESS["MAIN_OPTION_PUBL"] = "Composants Paramètres du cache";
$MESS["MAIN_OPTION_HTML_CACHE_OPT"] = "Paramètres de cache HTML";
...
$MESS["MAIN_OPTION_HTML_CACHE_STAT_POSTS"] = "Nettoyages de cache causés par la modification de données";
$MESS["MAIN_OPTION_HTML_CACHE_STAT_QUOTA"] = "Nettoyages de cache causés par le manque d'espace disque";
$MESS["MAIN_OPTION_HTML_CACHE_STAT_HITS"] = "Cache Hits";
$MESS["MAIN_OPTION_HTML_CACHE_SUCCESS"] = "Le mode de cache HTML a été changé avec succès.";
$MESS["MAIN_OPTION_HTML_CACHE_SAVE"] = "Sauvegarder les paramètres de cache HTML";
$MESS["MAIN_OPTION_HTML_CACHE"] = "HTML génération de la page";
