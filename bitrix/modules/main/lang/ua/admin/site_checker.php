...
";
$MESS["SC_HELP_CHECK_PULL_STREAM"] = "Для повноцінної роботи чату необхідне налаштування модуля <a href=\"http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=2033\"> Push and Pull </a>.
...
Відправка повідомлень на Apple і Android пристрою здійснюється через єдиний сервіс Бітрікс https://cloud-messaging.bitrix24.com через HTTPS.
